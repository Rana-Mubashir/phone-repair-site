function TopBanner({ categoryName }) {
    return (
      <div className="bg-gradient-to-r from-blue-200 via-blue-100 to-purple-100 px-4 py-8 md:py-12">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex flex-col gap-4 text-center md:text-left max-w-lg mb-8 md:mb-0">
              <div className="relative inline-block">
                ...
                <div className="absolute -bottom-2 left-0 w-12 h-1 bg-gradient-to-r from-[#34c5f1] to-[#a855f7] rounded-full md:block hidden"></div>
              </div>
              <h1 className="font-bold text-4xl md:text-5xl lg:text-5xl bg-gradient-to-r from-[#34c5f1] to-[#a855f7] bg-clip-text text-transparent animate-fade-in">
            ...
            <div className="relative">
              <div className="absolute -inset-1 bg-gradient-to-r from-[#34c5f1] via-[#a855f7] to-purple-300 rounded-full blur opacity-30 animate-pulse"></div>
